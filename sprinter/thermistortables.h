...
// 104GT-2 via::
// ./createTemperatureLookup.py --r0=100000 --t0=25 --r1=0 --r2=4700 --beta=4267
#if (THERMISTORHEATER == 101) || (THERMISTORBED == 101)
#define NUMTEMPS_101 20
const short temptable_101[NUMTEMPS_101][2] = {
   {1, 713},
   {54, 236},
   {107, 195},
   {160, 172},
...
// K164NK100 via::
// ./createTemperatureLookup.py --r0=100000 --t0=25 --r1=0 --r2=4700 --beta=4600
#if (THERMISTORHEATER == 102) || (THERMISTORBED == 102)
#define NUMTEMPS_102 20
const short temptable_102[NUMTEMPS_102][2] = {
   {1, 572},
   {54, 211},
   {107, 176},
   {160, 157},
...
#elif THERMISTORHEATER == 101
#define NUMTEMPS NUMTEMPS_101
#define temptable temptable_101
#elif THERMISTORHEATER == 102
#define NUMTEMPS NUMTEMPS_102
#define temptable temptable_102
...
#elif THERMISTORBED == 101
#define BNUMTEMPS NUMTEMPS_101
#define bedtemptable temptable_101
#elif THERMISTORBED == 102
#define BNUMTEMPS NUMTEMPS_102
#define bedtemptable temptable_102
